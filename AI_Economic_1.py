# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 10:28:49 2024
...
print(f'基于更多特征的市场预测 | MLP (scikit-learn包) | IN-SAMPLE | Close | acc={acc:.4f}')
...
acc = accuracy_score(df['d'], pred)
print(f'基于更多特征的市场预测 | DNN (keras包) | IN-SAMPLE | Close | acc={acc:.4f}')
...
def train_test_model(model):
    ...
    print(f'检验过拟合 | MLP (scikit-learn包) | OUT-OF-SAMPLE | Close | acc={acc:.4f}')
